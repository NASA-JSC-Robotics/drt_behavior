...
// #include "ros2_yolos_cpp/nodes/DepthToPointcloud_node.hpp"
...
class DepthToPointcloud : public BT::StatefulActionNode
{
public:
  DepthToPointcloud(const std::string& name, const BT::NodeConfig& config);
...
private:
  ...
  static constexpr auto kCameraInfoTopic = "camera_info_topic";
  ...
  // static constexpr auto kSegmentationResults = "segmentation_results";

  // std::unique_ptr<ros2_yolos_cpp::IDepthToPointcloudAdapter> DepthToPointcloud_;
};
