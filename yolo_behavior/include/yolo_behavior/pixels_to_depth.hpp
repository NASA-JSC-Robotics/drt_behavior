...
{
class PixelsToDepth : public BT::StatefulActionNode
{
public:
  PixelsToDepth(const std::string& name, const BT::NodeConfig& config);
...
private:
  ...
  std::vector<ros2_yolos_cpp::PoseResult> poses;
  ...
  // std::vector<ros2_yolos_cpp::PoseResult> results;
