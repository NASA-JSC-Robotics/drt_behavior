...
{
class Segmentor : public BT::StatefulActionNode
{
public:
  Segmentor(const std::string& name, const BT::NodeConfig& config);
...
private:
  ...
  std::unique_ptr<ros2_yolos_cpp::ISegmentorAdapter> segmentor_;
};
