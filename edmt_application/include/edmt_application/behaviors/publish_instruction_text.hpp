 ...
 *
 */
class PublishInstructionText : public BT::SyncActionNode
{
public:
  /**
   * @brief Constructor for PublishInstructionText behavior
   *
   * @param name Name of behavior
   * @param config BTCPP node config
   */
  PublishInstructionText(const std::string& name, const BT::NodeConfig& config);
