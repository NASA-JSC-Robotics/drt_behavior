 ...
 *
 */
class PublishTrajectory : public BT::SyncActionNode
{
public:
  /**
   * @brief Constructor for PublishTrajectory behavior
   *
   * @param name Name of behavior
   * @param config BTCPP node config
   */
  PublishTrajectory(const std::string& name, const BT::NodeConfig& config);
